...
from aid_scan.aid_bruteforce import aid_bruteforce
from aid_scan.aid_side_channel_discovery import aid_side_channel_discovery
from class_scan.class_bruteforce import class_bruteforce
from config import Config, MeasurementConfig, ExtractionConfig
from method_scan.method_bruteforce import method_bruteforce
from setup.measurement_setup import capture_sample_install_trace, capture_sample_call_trace
...
def init_parser() -> ArgumentParser:
    ...
    aid_scan_parser.add_argument('-n', '--byte_numbers', help="Byte numbers to test", required=True, nargs='+')
...
def main():
    ...
    if args.module == 'setup_extraction':
        ...
        extract_times_from_trs_file(args.number_of_measurements, args.trs_file, args.number_of_samples, config)
