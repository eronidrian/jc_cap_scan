...
# install setup
THRESHOLD = 25  # mv
SAMPLE_INTERVAL = 50  # ns
NUMBER_OF_SAMPLES = 100 * 10 ** 6
POSTTRIGGER_DELAY = 0  # ms
RANGE = 5
...
def setup_picoscope():
    ...
    chBRange = ps.PS6000_RANGE["PS6000_200MW"]  # PS6000_RANGE["PS6000_1V"]
    ...
    threshold = int(32512/200 * THRESHOLD)
