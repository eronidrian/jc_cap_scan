...
if __name__ == "__main__":
    ...
    # template = CapFile.load_from_directory("template_static_apdu_getcurrentapdubuffer_return/applets/javacard")
    # constant_pool_entry = template.constant_pool_component.get_cp_info_by_method_name("getcurrentapdubuffer")
    # constant_pool_entry.info.token = method_token
    # print(template.constant_pool_component)
    # template.export_to_directory(os.path.join(f"test_{method_token}", "applets", "javacard"))
    # cap_file_name = f"test_{method_token}.cap"
    # pack_directory_to_cap_file(cap_file_name, f"test_{method_token}")
