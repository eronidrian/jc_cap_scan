...
from cap_parser import constants
...
class DirectoryComponent(Component):
    ...
    def actual_component_sizes(self) -> bytearray:
        component_sizes = bytearray()
        for component in self.cap_file.get_components_in_standard_order():
            component_sizes.extend(int.to_bytes(component.size, 2))
        component_sizes.extend(bytearray.fromhex("00" * 6))
